...
public interface DonHangChiTietRepo extends JpaRepository<DonHangChiTiet, Integer> {
    ...
    @Query("SELECT c.sanPhamChiTiet.sanPham.id ,c.sanPhamChiTiet.sanPham.tenSanPham,c.sanPhamChiTiet.ngayTao, c.sanPhamChiTiet.mauSac.tenMauSac, c.sanPhamChiTiet.kichThuoc.tenKichThuoc ,MAX(c.gia),SUM(c.soLuong), MAX(c.sanPhamChiTiet.soLuong) FROM DonHangChiTiet c GROUP BY c.sanPhamChiTiet.sanPham.id, c.sanPhamChiTiet.id,c.sanPhamChiTiet.sanPham.tenSanPham,c.sanPhamChiTiet.ngayTao, c.sanPhamChiTiet.mauSac.tenMauSac, c.sanPhamChiTiet.kichThuoc.tenKichThuoc  ORDER BY SUM(c.soLuong) DESC")
    Page<Object[]> findBestSellingProducts(Pageable pageable);
    @Query("SELECT c.sanPhamChiTiet.sanPham.id ,c.sanPhamChiTiet.sanPham.tenSanPham,c.sanPhamChiTiet.ngayTao, c.sanPhamChiTiet.mauSac.tenMauSac, c.sanPhamChiTiet.kichThuoc.tenKichThuoc ,c.gia, SUM(c.soLuong), c.sanPhamChiTiet.soLuong FROM DonHangChiTiet c GROUP BY c.sanPhamChiTiet.sanPham.id,c.sanPhamChiTiet.sanPham.tenSanPham,c.sanPhamChiTiet.ngayTao, c.sanPhamChiTiet.mauSac.tenMauSac, c.sanPhamChiTiet.kichThuoc.tenKichThuoc ,c.gia, c.sanPhamChiTiet.soLuong ORDER BY (c.gia * SUM(c.soLuong)) DESC")
    ...
    @Query("SELECT Min(dhct.sanPhamChiTiet.id) ,dhct.sanPhamChiTiet.sanPham.tenSanPham, dhct.sanPhamChiTiet.giaBan, dhct.sanPhamChiTiet.mauSac.tenMauSac, SUM(dhct.soLuong) as totalQuantity, dhct.sanPhamChiTiet.imanges FROM DonHangChiTiet dhct WHERE dhct.sanPhamChiTiet.sanPham.thuongHieu.id = :id GROUP BY dhct.sanPhamChiTiet.sanPham.tenSanPham, dhct.sanPhamChiTiet.giaBan , dhct.sanPhamChiTiet.mauSac.tenMauSac , dhct.sanPhamChiTiet.imanges ORDER BY totalQuantity DESC")
